...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{GSD }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{complete.cases}\NormalTok{(subD50),}
\NormalTok{         (Lith_type }\OperatorTok{==}\StringTok{ "igneous"} \OperatorTok{|}\StringTok{ }\NormalTok{Lith_type }\OperatorTok{==}\StringTok{ "sedimentary"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{subD50_phi =} \KeywordTok{log2}\NormalTok{(subD50)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{relocate}\NormalTok{(subD50_phi, }\DataTypeTok{.after =}\NormalTok{ subD50) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Lith_type, }\DataTypeTok{y=}\NormalTok{ subD50_phi, }\DataTypeTok{color =}\NormalTok{ Lith_type))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \StringTok{"Subsurface D50 (phi)"}\NormalTok{, }\DataTypeTok{x =} \StringTok{""}\NormalTok{, }\DataTypeTok{color =} \StringTok{""}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"bottom"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Reproducible-Science-Project_files/figure-latex/boxplot-1.pdf}
...
\NormalTok{         (Lith_type }\OperatorTok{==}\StringTok{ "igneous"} \OperatorTok{|}\StringTok{ }\NormalTok{Lith_type }\OperatorTok{==}\StringTok{ "sedimentary"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{subD50_phi =} \KeywordTok{log2}\NormalTok{(subD50),}
         \DataTypeTok{surD50_phi =} \KeywordTok{log2}\NormalTok{(surD50)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ subD50_phi, }\DataTypeTok{y =}\NormalTok{ Lith_type, }\DataTypeTok{fill =}\NormalTok{ Lith_type)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_density_ridges}\NormalTok{(}\DataTypeTok{scale =} \DecValTok{8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \StringTok{""}\NormalTok{, }\DataTypeTok{x =} \StringTok{"D50"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Reproducible-Science-Project_files/figure-latex/density plot-1.pdf}
...
\NormalTok{GSD }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{complete.cases}\NormalTok{(subD50),}
\NormalTok{         (Lith_type }\OperatorTok{==}\StringTok{ "igneous"} \OperatorTok{|}\StringTok{ }\NormalTok{Lith_type }\OperatorTok{==}\StringTok{ "sedimentary"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{subD50_phi =} \KeywordTok{log2}\NormalTok{(subD50),}
         \DataTypeTok{surD50_phi =} \KeywordTok{log2}\NormalTok{(surD50)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ subD50_phi, }\DataTypeTok{y =}\NormalTok{ surD50_phi, }\DataTypeTok{color =}\NormalTok{ Lith_type))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_abline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{slope =} \DecValTok{1}\NormalTok{, }\DataTypeTok{intercept =} \DecValTok{0}\NormalTok{),  }
...
\StringTok{  }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{color =} \KeywordTok{guide_legend}\NormalTok{(), }\DataTypeTok{size =} \KeywordTok{guide_legend}\NormalTok{()) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Subsurface D50 (phi)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Surface D50 (phi)"}\NormalTok{, }
       \DataTypeTok{color =} \StringTok{"Lithology"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"bottom"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Reproducible-Science-Project_files/figure-latex/scatterplot-1.pdf}
...
\hypertarget{evaluating-the-gartner-et-al.-2014-model}{%
\chapter{Evaluating the Gartner et al., 2014 model}\label{evaluating-the-gartner-et-al.-2014-model}}

Plotting the Observed Volume vs predicted volume:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{volume }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obsVol, }\DataTypeTok{size =}\NormalTok{ obsVol))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ G14_vol100yr), }\DataTypeTok{color =} \StringTok{"slateblue4"}\NormalTok{, }\DataTypeTok{label =} \StringTok{"100 year storm"}\NormalTok{) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{scale_size_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{500}\NormalTok{, }\DecValTok{10000}\NormalTok{, }\DataTypeTok{by=}\DecValTok{2000}\NormalTok{))}\OperatorTok{+}
...
\StringTok{  }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{size =} \KeywordTok{guide_legend}\NormalTok{()) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Observed Volume"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Modeled Volume"}\NormalTok{  )}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Reproducible-Science-Project_files/figure-latex/volume model-1.pdf}
